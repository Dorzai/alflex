...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Specify the amount of time the access tokens and refresh tokens will
    | be valid.
    |
    */
    
    'access_tokens_expire_in_minutes' => 10,
    'refresh_tokens_expire_in_minutes' => 60*24*30,     // 30 days
